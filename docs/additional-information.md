...
```erlang
pip install -I https://github.com/Xcod3bughunt3r/InstaPy/requirements.txt
```
...
```erlang
git clone https://github.com/Xcod3bughunt3r/InstaPy.git
```
...
```erlang
pip install git+https://github.com/Xcod3bughunt3r/InstaPy.git
```
